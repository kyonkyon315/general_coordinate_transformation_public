...
0D2V_const_field_sqrt_super.cpp -o vlasov 
#correct_ope_split.cpp -o vlasov
#whistler_kappa_super_mv_av.cpp -o vlasov
#whistler_kappa_super.cpp -o vlasov 
