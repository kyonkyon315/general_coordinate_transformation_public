...
if __name__ == "__main__":
    ...
    for rank in [0]:
        all_files = ["../output/0D2V_pole/step_" + str(i) + "_rank_"+str(rank)+".bin" for i in range(50)]
        
        # 条件: i%4 != 0 かつ i < 5000 のファイルのみ抽出
        target_files = [fn for i, fn in enumerate(all_files) if i % 1 == 0 and i < 100]
        ...
        # GIF 保存
        gif_path = "../output/0D2V_const_field_"+str(rank)+".gif"
        fps = 3
