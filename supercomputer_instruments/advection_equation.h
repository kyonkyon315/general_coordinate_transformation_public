...
private:
    ...
    void solve_leaf_impl_indices(Value dt, Value& Up, Value& Um, std::index_sequence<Is...>, Ints... indices){
        ...
        //Value nyu_p_half = - dt * (advection+advection_p_1)/2. * (1. - dt * (advection_p_1 - advection)/2.);
        Value nyu_m_half = - dt * (advection+advection_m_1)/2.;
        //Value nyu_m_half = - dt * (advection+advection_m_1)/2. * (1. - dt * (advection - advection_m_1)/2.);
